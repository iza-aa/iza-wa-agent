...
export class PdfReportService {
    ...
    // -------------------------------------------------------------------
    drawHeader(doc, monthLabel, count) {
        let y = MARGIN;
    ...
    // -------------------------------------------------------------------
    drawDepartmentBreakdown(doc, startY, data) {
        let y = startY;
    ...
    // -------------------------------------------------------------------
    drawTransactionTable(doc, startY, data) {
        let y = startY;
        doc.fillColor(COLOR.ink).font(FONT.bold).fontSize(11)

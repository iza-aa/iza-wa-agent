        ...
        for (const msg of messages) {
            ...
            try {
                ...
                if (result.buttons && result.buttons.length > 0) {
                    await metaApiClient.sendInteractiveButtons(senderPhone, result.reply, result.buttons);
                }
                ...
                await metaApiClient.sendTextMessage(senderPhone, "⚠️ Mohon maaf, terjadi kendala sementara saat memproses pesan Anda. Silakan coba kirim ulang.");
            }
        }
    }
}

        ...
        try {
            ...
            const normalizedItems = (rawTrx.items || []).map((it) => {
                ...
                if (rawDept.includes("dapur") || rawDept.includes("kitchen"))
                    ...
                    dept = "Kafe";
                else if (userTextLower.includes("dapur") || userTextLower.includes("pasar"))
                    dept = "Dapur";
                else if (userTextLower.includes("barista"))
                    dept = "Barista";
                else if (userTextLower.includes("waiter"))
                    dept = "Waiters";
                else if (userTextLower.includes("kasir"))
                    dept = "Kasir";
                return {

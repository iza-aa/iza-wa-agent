...
export function extractDeterministicSearchIntent(userQuery: string): SearchIntent | null {
  ...
  if (isExpenseInquiry || isIncomeInquiry) {
    ...
    if (lower.includes("cash") || lower.includes("tunai")) paymentMethod = "Cash";
    else if (lower.includes("mandiri")) paymentMethod = "Mandiri";
    else if (lower.includes("bca")) paymentMethod = "BCA";
    else if (lower.includes("bri")) paymentMethod = "BRI";
